...
void main() {
    ...
    //vec3 ibl = diffuse * ambient.intensity + specular * (ambient.intensity * 0.15); //0.15
    vec3 ambient_contrib = ambient.color * ambient.intensity;
    vec3 ibl = diffuse + specular; //0.15
